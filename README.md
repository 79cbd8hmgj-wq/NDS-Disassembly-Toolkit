...
- Phase 7M interprocedural prototype recovery with explicit SSA `r0` call-result heritage, conservative parameter/return type propagation across unique direct calls, typed used-call temporaries, recursive fixed-point convergence, and automatic project-wide prototype context for `project decompile`;
